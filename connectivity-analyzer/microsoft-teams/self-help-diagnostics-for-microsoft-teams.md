...
| [Teams Federation and Interoperability](https://testconnectivity.microsoft.com/tests/TeamsFederation/input)	| This diagnostic is specifically tailored to identify problem where a Teams user cannot search for or initiate chats with an external user. The external user may be utilizing various clients, including Teams, Skype for Business, Skype Consumer, or Teams for Life. In addtion, the diagnostic will comprehensively address federation, interoperability, and public instant messaging (including Teams for Life and Skype Consumer) scenarios. |
